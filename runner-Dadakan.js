...
(async () => {
    ...
    try {
        await tryWithRetry('node getData-Dadakan.js');
        await tryWithRetry('node getRes-Dadakan.js');
        await tryWithRetry('node addDataUser-Dadakan.js');
        // await tryWithRetry('node getFair-Dadakan.js');
        await tryWithRetry('node getFairDaily-Dadakan.js');
        await tryWithRetry('node getFairMonthly-Dadakan.js');
