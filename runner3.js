...
const urls = [
    `http://localhost:7771/instagram/getDataPostByKeywords?kategori=persib_medmon`,
    `http://localhost:7772/tiktok/getDataPostByKeywords?kategori=persib_medmon`,
    `http://localhost:7773/youtube/getDataPostByKeywords?start_date=${startStr}&end_date=${endStr}&kategori=persib_medmon`,
    `http://localhost:7774/facebook/getDataPostByKeywords?start_date=${startStr}&end_date=${endStr}&kategori=persib_medmon`,
];
